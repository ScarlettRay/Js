...
var dataDitionary3 = {
    urls: {
        ...
        userhotweibo: [
            "http://weibo.com/p/1005052206258462/home?profile_ftype=1&is_all=1#_0",			//NASA中文
            "http://weibo.com/entpaparazzi?profile_ftype=1&is_all=1#_0",					//新浪娱乐
            "http://weibo.com/u/1749224837?profile_ftype=1&is_all=1#_0",					//IT工程师
            "http://weibo.com/u/5150774534?profile_ftype=1&is_all=1#_0",					//黑客师
            "http://weibo.com/u/5222794628?profile_ftype=1&is_all=1#_0",					//舌尖上的菜谱
            "http://weibo.com/u/5879823459?profile_ftype=1&is_all=1#_0",					//一米便当
            "http://weibo.com/feidieshuo9527?profile_ftype=1&is_all=1#_0",					//飞碟说
            "http://weibo.com/920722209?profile_ftype=1&is_all=1#_0",						//史上第一最最搞
            "http://weibo.com/u/3440325930?profile_ftype=1&is_all=1#_0",					//纯良叫兽
            "http://weibo.com/houson100037?profile_ftype=1&is_all=1#_0",					//Houson猴姆
            "http://weibo.com/luvmuzik?profile_ftype=1&is_all=1#_0",						//DC大叔
            "http://weibo.com/u/5337879011?profile_ftype=1&is_all=1#_0",					//腐剧天天看
            "http://weibo.com/u/3947532062?profile_ftype=1&is_all=1#_0",					//电影攻略菌
            "http://weibo.com/tamaxingzhe?profile_ftype=1&is_all=1#_0",						//踏马行者
            "http://weibo.com/ergengshipin?profile_ftype=1&is_all=1#_0",					//二更视频
            "http://weibo.com/juziyule?profile_ftype=1&is_all=1#_0",						//橘子娱乐
            "http://weibo.com/iampaparazzi?profile_ftype=1&is_all=1#_0",					//全名星探
            "http://weibo.com/u/1418070140?profile_ftype=1&is_all=1#_0"						//微博美女
        ],
    },
    weiboSum: 2,     //每轮发送的博文数
    time: 10 * 60 * 1000,        //间隔时间
    mids: null, //存放mid
    comments: null,   //存放评论
...
function service() {
    for (var i = 0; i < dataDitionary3.weiboSum; i++) {
        if (dataDitionary3.hadSendEeiBoMid.indexOf(dataDitionary3.mids[i]) < 0) {
...
function WeiBoforword(i) {
    ...
    dataDitionary3.hadSendEeiBoMid.push(dataDitionary3.mids[i]);
}
/**
 * 获取文档Ajax
 */
function getDoc() {
    var randomNum = Math.floor(Math.random() * dataDitionary3.urls.userhotweibo.length);
...
function getmids(result) {
    ...
    for (var i = 0; i < dataDitionary3.weiboSum; i++) {
		...
		if(matches[0].slice(9).indexOf('"')>-1){	//转发博文的mid比较特殊
			dataDitionary3.mids.push(matches[0].slice(10));
		}else{
...
(function sendWeiBoStart() {
    sendWeiBoService();
    timer = setInterval("sendWeiBoService()", 25 * 60 * 1000);
})();